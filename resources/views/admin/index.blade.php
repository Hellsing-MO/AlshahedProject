                  ...
                  <div class="row mb-8">
                     <div class="col-md-12">
                        ...
                        <div
                           ...
                           style="background-image: url({{asset('images/Vector Smart Object.png')}}); background-repeat: no-repeat; background-size: cover; background-position: right">
                           <div class="card-body p-lg-12">
                              <h1>Welcome back! Alshahed honey</h1>
