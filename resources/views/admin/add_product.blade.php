                           ...
                           <div class="row">
                            ...
                            <!-- input -->
                              ...
                              <div class="mb-3 col-lg-12 mt-5">
                                 ...
                                 <input style="height: 300px" type="text" name="description" class="form-control" placeholder="description" required />
                                 
                              </div>
                              <div class="d-grid">
                                <input href="#" class="btn btn-primary" type="submit" value="Add Product">
                             </div>
                            </form>
                           </div>
                        </div>
