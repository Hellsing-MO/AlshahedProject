    ...
    <header class="header" data-header>
      <div class="container">
        ...
        <a href="{{url('/')}}" class="logo logo-container">
          ...
          <a href="{{url('shipping')}}" class="mobile-cart-icon" data-count="{{$count}}">
        ...
        <nav class="navbar" data-navbar>
          ...
          <ul class="navbar-list">
            ...
            @auth
            <div class="nav-icons">
              <a href="{{url('shipping')}}"><i class='bx bx-cart'>[{{$count}}]</i></a>
            ...
            <div class="nav-icons">
              <a href="{{url('shipping')}}"><i class='bx bx-cart nav-cart'>[{{$count}}]</i></a>
              <div class="bx bx-menu" id="menu-icon"></div>
            </div>
